...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admins/css/auth.css') }}">
    <style>
        #preloader {
            position: fixed;
            top: 0;
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-6">
                <div class=" text-center">
                    ...
                    <h4 class="fw-bold text-white mb-3">Login Page</h4>
                    <form method="POST" action="{{ route('admin.login') }}" class="text-start mt-4 needs-validation"
                        novalidate>
                        @csrf
                        <div class="mb-3">
                            ...
                            <div class="invalid-feedback text-left px-3">
                        ...
                        <button type="submit" class="btn btn-view-menu w-100">Login</button>
                    </form>
                </div>
            </div>
        </div>
